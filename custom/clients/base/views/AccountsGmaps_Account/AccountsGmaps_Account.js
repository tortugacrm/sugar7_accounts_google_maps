...
({
    ...
    initDashlet: function() {
        ...
        //}
        this.my_data = '';
        this.model.on("change:billing_address_street", this.loadData, this);
        this.model.on("change:billing_address_postalcode", this.loadData, this);
        this.model.on("change:billing_address_city", this.loadData, this);
        this.model.on("change:billing_address_country", this.loadData, this);
    ...
    loadData: function(options) {
        ...
        */
        ...
        var self = this;
        var args = '';
        args = 'AccountsGmaps/GetAccount?accountid='+this.model.get("id");
		var myself = this;
